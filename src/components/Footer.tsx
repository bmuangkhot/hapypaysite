        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Transforming the way people send and receive money with our innovative financial technology solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">eWallet</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">P2P Transfer</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">P2M Payments</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">Business Solutions</a></li>
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">API Documentation</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary">FAQs</a></li>
